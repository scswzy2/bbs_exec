...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="tables"><a href="tables.html" title="" class="active exp" id="current"><span>Tables</span><strong>3</strong></a>
            <ul class="sub">
                <li class="this"><a href="table_static.html" title="">Static tables</a></li>
...
<div id="rightSide">
    ...
    <div class="resp">
        ...
        <div class="cLine"></div>
        <div class="smalldd">
            <span class="goTo"><img src="images/icons/light/frames.png" alt="" />Static tables</span>
    ...
    <div class="wrapper">
        ...
        <div class="widget rightTabs">  
            <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>Tabbed tables</h6></div>     
            <ul class="tabs">
                <li><a href="#tab3">6 cols</a></li>
                <li><a href="#tab4">7 cols</a></li>
            </ul>
