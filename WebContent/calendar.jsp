...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="tables"><a href="tables.html" title="" class="exp"><span>Tables</span><strong>4</strong></a>
            <ul class="sub">
        ...
        <li class="typo"><a href="#" title="" class="active exp" id="current"><span>Other pages</span><strong>3</strong></a>
            <ul class="sub">
                ...
                <li class="this"><a href="calendar.html" title="">Calendar</a></li>
...
<div id="rightSide">
    ...
    <div class="resp">
        ...
        <div class="cLine"></div>
        <div class="smalldd">
            <span class="goTo"><img src="images/icons/light/monthCalendar.png" alt="" />Events calendar</span>
