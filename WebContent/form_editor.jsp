    ...
    <ul id="menu" class="nav">
        ...
        <li class="forms"><a href="#" title="" class="active exp" id="current"><span>Forms stuff</span><strong>4</strong></a>
            <ul class="sub">
                ...
                <li class="this"><a href="form_editor.html" title="">WYSIWYG and file uploader</a></li>
...
<div id="rightSide">
    ...
    <div class="resp">
        ...
        <div class="cLine"></div>
        <div class="smalldd">
            <span class="goTo"><img src="images/icons/light/pencil.png" alt="" />WYSIWYG and file uploader</span>
    ...
    <div class="titleArea">
        <div class="wrapper">
            <div class="pageTitle">
                <h5>WYSIWYG and multiple file uploader</h5>
    ...
    <div class="wrapper">
        ...
        <!-- WYSIWYG editor -->
        <div class="widget">
            <div class="title"><img src="images/icons/dark/pencil.png" alt="" class="titleIcon" /><h6>WYSIWYG editor</h6></div>
            <textarea id="editor" name="editor" rows="" cols=""></textarea>
        </div>
        
        <!-- Multiple files uploader -->
        <div class="widget">
            <div class="title"><img src="images/icons/dark/upload.png" alt="" class="titleIcon" /><h6>Multiple file uploader</h6></div>
            <div id="uploader"></div>
        </div>
    </div>
