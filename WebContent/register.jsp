...
<script src="${pageContext.request.contextPath }/static/"></script>
...
<div id="leftSide">
    ...
    <div class="genBalance">
        <a href="${pageContext.request.contextPath }/static/#" title="" class="amount">
            <span>General balance:</span>
            <span class="balanceAmount">$10,900.36</span>
        </a>
        <a href="${pageContext.request.contextPath }/static/#" title="" class="amChanges">
    ...
    <ul id="menu" class="nav">
        ...
        <li class="charts"><a href="${pageContext.request.contextPath }/static/charts.html" title=""><span>Statistics and charts</span></a></li>
        <li class="forms"><a href="${pageContext.request.contextPath }/static/#" title="" class="active exp" id="current"><span>Forms stuff</span><strong>4</strong></a>
            <ul class="sub">
...
<div id="rightSide">
    ...
    <div class="wrapper">
        ...
        <!-- Validation form -->
        <form id="validate" class="form" method="post" action="${pageContext.request.contextPath}/reg">
        	<fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <div class="floatL" style="margin: 2px 0 0 10px;"><input type="radio" checked="checked" id="checkReq" name="userSex" class="validate[required]" data-prompt-position="topRight:102" /><label for="checkReq">男</label></div>
                            <div class="floatL" style="margin: 2px 0 0 0;"><input type="radio" id="radioReq" name="userSex" class="validate[required]" data-prompt-position="topRight:102" /><label for="radioReq">女</label></div>
