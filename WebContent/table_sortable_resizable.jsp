    ...
    <ul id="menu" class="nav">
        ...
        <li class="tables"><a href="tables.html" title="" class="active exp" id="current"><span>Tables</span><strong>3</strong></a>
            <ul class="sub">
                ...
                <li class="this last"><a href="table_sortable_resizable.html" title="">Sortable &amp; resizable tables</a></li>
            </ul>
        </li>
...
<div id="rightSide">
    ...
    <div class="resp">
        ...
        <div class="cLine"></div>
        <div class="smalldd">
            <span class="goTo"><img src="images/icons/light/frames.png" alt="" />Resizable and sortable tables</span>
    ...
    <div class="titleArea">
        <div class="wrapper">
            <div class="pageTitle">
                <h5>Sortable and resizable tables</h5>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>Table with sortable columns</h6></div>
        ...
        <div class="widget">
            ...
            <h6>Table with resizable columns</h6></div>
        ...
        <div class="widget">
            <div class="title"><img src="images/icons/dark/frames.png" alt="" class="titleIcon" />
            <h6>Both: resizable and sortable</h6></div>
